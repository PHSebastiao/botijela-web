...
## Usage
Before running this project, you will need to set up your .env based on .env.example:
...
Optionally, you may modify the requested scopes when the /auth/twitch route is defined or how many callbacks you want.
